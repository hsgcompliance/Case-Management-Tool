...
export function DatabaseFilterPanel({ value, onChange, toolKind, onRefreshCollection, refreshingCollection }: Props) {
  ...
  return (
    <div className="relative">
      ...
      {open ? (
        <div className="absolute right-0 z-30 mt-2 w-[min(92vw,760px)] rounded-lg border border-slate-200 bg-white p-3 shadow-lg dark:border-slate-800 dark:bg-slate-950">
          <div className="mb-3 flex items-center justify-between gap-3">
            <div>
              <div className="text-sm font-semibold text-slate-900 dark:text-slate-50">Database filters</div>
              <div className="text-xs text-slate-500">Limit which cached and scoped database rows feed this review.</div>
            </div>
