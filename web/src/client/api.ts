...
export const endpointsStrict = {
  ...
  enrollmentsUndoMigration: { method: 'POST', path: 'undoEnrollmentMigration' },
  enrollmentsAdminReverseLedgerEntry: { method: 'POST', path: 'adminReverseLedgerEntry' },
  ...
  paymentsBulkSpend:             { method: 'POST', path: 'paymentsBulkSpend' },
  paymentsUpdateCompliance:      { method: 'POST', path: 'paymentsUpdateCompliance' },
  paymentsBulkUpdateCompliance:  { method: 'POST', path: 'paymentsBulkUpdateCompliance' },
