...
import { OrgSelector, TeamBuilder } from "@entities/org";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 space-y-6">
      ...
      <TeamBuilder
        ...
        busy={patchTeamsMut.isPending}
        onTeamIdChange={setTeamIdInput}
        ...
        onRemoveTeam={(teamId) => {
          if (!selectedOrg) return;
          patchTeamsMut.mutate({ orgId: selectedOrg.id, remove: [teamId] });
        }}
      />
