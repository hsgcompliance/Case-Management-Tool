      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="Re-check the customer document, Drive folder, and workbook links — use this after linking or editing them from the main web app"
            className="rounded-md border border-slate-200 bg-white px-2 py-1.5 text-xs font-semibold text-slate-500 hover:bg-slate-50 disabled:opacity-50"
          >
            {loading ? "…" : "↻ Refresh"}
          </button>
