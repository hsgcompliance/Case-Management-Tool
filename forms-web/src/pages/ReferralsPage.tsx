      ...
      <div className="space-y-3">
        ...
        {pipesToIntake && !submitted ? (
          <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-500">
            Submitting this referral continues into the Basic Intake flow automatically. You don't have to finish
            it — the intake can be saved and sent to compliance or another case manager at any point from the
            Actions menu.
          </div>
        ) : null}
